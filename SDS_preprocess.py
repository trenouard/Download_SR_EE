...
def preprocess_single(fn, satname, cloud_mask_issue):
    ...
    im_extra : np.array
        ...
        panchromatic band for Landsat 7 and Landsat 8. This field is empty for Landsat 5) Here empty for Landsat 5-7-8  because not needed.
    im_QA: np.array
